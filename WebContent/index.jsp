...
<html lang="en">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Do+Hyeon&family=Jua&family=Yeon+Sung&display=swap" rel="stylesheet">
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#QnA_about">Portfolio</a></li>
        ...
        <div class="masthead_container">
            <div class="row h-100 align-items-center justify-content-center text-center">
                ...
                <div class="col-lg-8 align-self-baseline">
                    ...
                    <a class="btn btn-primary btn-xl js-scroll-trigger" href="#about" id="apply"> 신청하기 </a>
                </div>
            </div>
        </div>
    </header>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        <h2 class="text-white mt-0"> 소개 </h2> <!-- 비전, 핵심가치 -->
                        <hr class="divider light my-4" />
                        <p class="text-white-50 mb-4">
                            안녕하세요! 저희는 티키타카 서비스를 운영중에 있는 팀 비프렌즈입니다.
        ...
        <section class="page-section" id="services">
            <div class="container">
                <h2 class="text-center mt-0" id="services_title"> 티키타카 진행방식 </h2>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 text-center" id="block">
                        <div class="mt-5">
                            ...
                            <p class="text-muted mb-0"> 남자 3명 여자 3명이 <br> 정해진시간에 저희가 열어둔 zoom으로 들어옵니다. </p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center" id="block">
                        <div class="mt-5">
                            <i class="fas fa-4x fa-laptop-code text-primary mb-4"></i>
                            <h3 id="block_title"> 진행 </h3>
                            <p class="text-muted mb-0"> 저희측 진행자가 참여하여 진행을 맡습니다. </p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center" id="block">
                        <div class="mt-5">
                            ...
                            <p class="text-muted mb-0"> 미팅은 총2시간 동안 진행되며 중간에 10분의 쉬는시간을 가집니다. </p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center" id="block">
                        <div class="mt-5">
                            <i class="fas fa-4x fa-heart text-primary mb-4"></i>
                            <h3 id="block_title">Made with Love</h3>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        ...
                        <hr class="divider my-4" />
                        <p class="text-muted mb-5" id="contact_text">
